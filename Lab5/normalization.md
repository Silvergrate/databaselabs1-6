...
![Поле tag_list з неатомарними значеннями](Screenshots/tag_list_problem.png)

![Повторювані типи товарів у таблиці product](Screenshots/product_type_duplicates.png)

![Повторювані статуси замовлень](Screenshots/order_status_duplicates.png)

![Повторювані методи та статуси платежів](Screenshots/payment_method_status_duplicates.png)
...
Проблема полягає в полі `tag_list`. Воно містить не одне значення, а список тегів, наприклад:
...
Таке поле порушує першу нормальну форму, бо значення в колонці не є атомарним.
...
![Нормалізована таблиця product з довідником product_type](Screenshots/normalized_product.png)
...
![Нормалізована таблиця bot_order з довідником order_status](Screenshots/normalized_order.png)
...
![Нормалізована таблиця payment з довідниками method і status](Screenshots/normalized_payment.png)
...
![Нормалізовані теги публікацій через publication_tag](Screenshots/normalized_publication_tags.png)

## 6. Оновлена ER-діаграма

Після нормалізації була оновлена ER-діаграма.

![Оновлена ER-діаграма після нормалізації](Screenshots/normalized_er_diagram.png)

На оновленій діаграмі додано нові таблиці:
